...
class PostRepository implements PostInterface
{
    ...
    public function createMember(array $data) : ?object
    {
        $query = Member::create([
            ...
            'member_deputy_name' => $data["member_deputy_name"],
            'member_email' => $data["member_email"],
            'member_phone' => $data["member_phone"],
            'member_address' => $data["member_address"],
            'member_bio' => $data["member_bio"],
            'member_function' => $data["member_function"],
            'member_name_ru' => $data["member_name_ru"],
            'member_name_en' => $data["member_name_en"],
            'member_deputy_name_ru' => $data["member_deputy_name_ru"],
            'member_deputy_name_en' => $data["member_deputy_name_en"],
            'member_bio_ru' => $data["member_bio_ru"],
            'member_bio_en' => $data["member_bio_en"],
            'member_function_ru' => $data["member_function_ru"],
            'member_function_en' => $data["member_function_en"],
